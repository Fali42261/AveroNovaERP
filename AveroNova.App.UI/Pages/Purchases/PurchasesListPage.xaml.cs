...
public partial class PurchasesListPage : ContentPage
{
    ...
    private View BuildRow(PurchaseModel p)
    {
        ...
        {
            PurchaseStatus.Received        => ("#ECFDF5", "#059669"),
            PurchaseStatus.Ordered         => ("#EFF6FF", "#2563EB"),
            PurchaseStatus.PartialReceived => ("#FFFBEB", "#D97706"),
            PurchaseStatus.Cancelled       => ("#F3F4F6", "#9CA3AF"),
            _                              => ("#F9FAFB", "#6B7280")
        };
