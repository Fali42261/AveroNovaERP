...
public partial class ReportsPage : ContentPage
{
    ...
    private async Task LoadAsync()
    {
        try
        {
            ...
            var revenue = invoices.Sum(x => x.Items.Where(i => !i.IsDeleted).Sum(i =>
                i.UnitPrice * i.Quantity * (1m - i.DiscountPct / 100m) * (1m + i.TaxPct / 100m)));
            ...
            OutstandingValue.Text = FormatMoney(outstanding);
        ...
        ReportsList.Children.Add(new Border
        {
            ...
            Content = new VerticalStackLayout
            {
                ...
                Children =
                {
                    ...
                    new Label { Text = description, FontSize = 12, TextColor = Color.FromArgb("#64748B") }
                }
            }
        });
    }
    ...
    private void ResetValues()
    {
        ...
        AddReportCard("Receivables Report", "No outstanding customer balance.");
    }
