...
/// <summary>
/// Builds dashboard figures from existing module services.
/// Local SQLite / mock / future API implementations of those services are interchangeable.
/// </summary>
public sealed class DashboardService : IDashboardService
{
    ...
    public async Task<DashboardSnapshot> GetSnapshotAsync(CancellationToken cancellationToken = default)
    {
        ...
        static bool IsActiveSale(InvoiceModel i)
        ...
        decimal SalesBetween(DateTime fromInclusive, DateTime toExclusive)
            => sales.Where(i => i.InvoiceDate.Date >= fromInclusive && i.InvoiceDate.Date < toExclusive)
                .Sum(i => i.GrandTotal);
        ...
        var recent = invoices
            ...
            .Take(6)
            .Select(i => new DashboardTransactionItem
            {
                Id = i.LocalId,
        ...
        if (lowStock.Count > 0)
        {
            ...
            {
                Title = "Low stock",
                Detail = lowStock.Count == 1
                    ? $"{lowStock[0].Name} is at or below minimum stock."
                    : $"{lowStock.Count} products are at or below minimum stock.",
        ...
        return new DashboardSnapshot
        {
            ...
            TodayCollection = todayPayments.Sum(p => p.Amount),
    ...
    {
        if (!string.IsNullOrWhiteSpace(user?.AvatarInitials))
